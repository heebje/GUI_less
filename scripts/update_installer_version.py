...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=GUI_less Demo Installer\n"
      else:
        line="OutputBaseFilename=GUI_less Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the GUI_less Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the GUI_less installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=GUI_less Demo installer\n"
     else:
       line="SetupWindowTitle=GUI_less installer\n"
